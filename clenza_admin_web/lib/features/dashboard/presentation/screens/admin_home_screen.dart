        ...
        return Scaffold(
          ...
          appBar: isMobile
              ? AppBar(
                  ...
                  elevation: 0,
                  title: const Text('Clenza Admin', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
                  ...
                  child: ListView(
                    ...
                    children: [
                      const DrawerHeader(
                        ...
                        child: Text('Clenza Admin', style: TextStyle(color: Colors.white, fontSize: 20)),
                      ),
